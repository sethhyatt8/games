...
export const PLACES: Place[] = [
  ...
  { id: 'grand-canyon', name: 'Grand Canyon South Rim', category: 'Nature', lat: 36.057, lng: -112.107 },
  { id: 'yellowstone', name: 'Old Faithful', category: 'Nature', lat: 44.4605, lng: -110.8282 },
  ...
  { id: 'great-wall', name: 'Great Wall at Mutianyu', category: 'Landmark', lat: 40.4319, lng: 116.5704 },
